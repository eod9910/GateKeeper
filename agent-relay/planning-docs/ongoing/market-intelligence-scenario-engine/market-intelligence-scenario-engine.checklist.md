...
- [x] All API contracts have a fixture file (25 fixtures in `agent-relay/planning-docs/ongoing/market-intelligence-scenario-engine/api-fixtures/market-intelligence/`; live-captured for Phase 1 endpoints, hand-written for Phase 2/3)
