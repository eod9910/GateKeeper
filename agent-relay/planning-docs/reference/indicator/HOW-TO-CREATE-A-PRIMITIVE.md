...
| `agent-relay/planning-docs/ongoing/primitive-normalization-contract-v0.md` | Canonical primitive contract spec |
| `agent-relay/planning-docs/ongoing/legacy-plugin-conversion-plan.md` | How legacy plugins are being converted to primitives |
