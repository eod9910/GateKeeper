...
pattern-detector/
  ...
  agent-relay/planning-docs/                 Planning, reference, prompts, research studies
  ...
  agent-relay/planning-docs/reference/ Durable reference docs and codebase orientation
  tools/                     Utility tools
...
`agent-relay/planning-docs/plans` is the canonical planning tree. Active and completed workstreams use PRD/checklist pairs. Reference docs live under `agent-relay/planning-docs/REFERENCE`.
