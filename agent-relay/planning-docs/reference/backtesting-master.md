...
- `agent-relay/planning-docs/validator-pipeline-anatomy.md`
- `agent-relay/planning-docs/validator-build-report.md`
- `agent-relay/planning-docs/fix-validator-progress.md`
- `agent-relay/planning-docs/fix-validator-universe-bug.md`
- `agent-relay/planning-docs/Regime-Aware, Structure-First Backtesting Framework.md`
- `agent-relay/planning-docs/backtesting_volitity_rdp_regression.md`
- `agent-relay/planning-docs/Pending/validation_report_spec.md`
- `agent-relay/planning-docs/validator-v1-board/*`
