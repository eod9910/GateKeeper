...
- active planning docs under `agent-relay/planning-docs/ongoing/`
...
- [workspace-agent-harness-plan.md](../agent-relay/planning-docs/ongoing/workspace-agent-harness-plan.md)
- [ledger-data-storage-and-retrieval-architecture.md](../agent-relay/planning-docs/ongoing/ledger-data-storage-and-retrieval-architecture.md)
- [DATA_CONTRACT.md](../workspace/Financial%20Analyst%20Workspace/DATA_CONTRACT.md)
- [ledger-normalization-family-design.md](../agent-relay/planning-docs/ongoing/ledger-normalization-family-design.md)
