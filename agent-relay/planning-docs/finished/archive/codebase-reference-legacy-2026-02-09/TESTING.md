...
**Current status:** Materially stale. This document says no tests exist, but the current repo has TypeScript service tests, a backend `npm test` script, and Python unittest suites.
