...
**Orientation audit:** 2026-06-02
**Current status:** Materially stale. The repo has grown substantially; use this as historical orientation only until refreshed.
...
├── agent-relay/planning-docs/                # Planning documents
...
- `agent-relay/planning-docs/` — Architecture and structure documentation (this file)
