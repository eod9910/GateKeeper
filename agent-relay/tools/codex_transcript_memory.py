...
TOPIC_DEFINITIONS = [
    ...
    },
    {
        ...
        "summary": "relay-local mirroring of Codex session rollouts and compact transcript views",
        "next_step": "Keep the Codex transcript mirror running and use agent-relay transcripts as the startup bridge.",
        "keywords": (
            "codex",
            "transcript",
            "conversation",
