...
export function searchAppReference(query: string): string | null {
  ...
  const keywordSections: Record<string, string[]> = {
    ...
    'pattern gate': ['Blockly Composer: Pattern Gate Socket'],
    'typed socket': ['Blockly Composer: Structure Socket', 'Blockly Composer: Location Socket', 'Blockly Composer: Timing Trigger Socket', 'Blockly Composer: Pattern Gate Socket'],
