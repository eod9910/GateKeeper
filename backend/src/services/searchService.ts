...
export function searchAppReference(query: string): string | null {
  ...
  const keywordSections: Record<string, string[]> = {
    ...
    'symbolic regression': ['Blockly Composer: Symbolic Regression Strategies'],
    'sr strategy': ['Blockly Composer: Symbolic Regression Strategies'],
    'sr formula': ['Blockly Composer: Symbolic Regression Strategies'],
    'sr score': ['Blockly Composer: Symbolic Regression Strategies'],
    'formula_id': ['Blockly Composer: Symbolic Regression Strategies'],
    'research studio sr': ['Blockly Composer: Symbolic Regression Strategies'],
    'promote to tier-1': ['Blockly Composer: Symbolic Regression Strategies'],
