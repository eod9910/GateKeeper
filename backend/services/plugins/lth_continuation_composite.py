"""Composite wrapper for lth_continuation_composite — uses composite_runner.py"""

from plugins.composite_runner import run_composite_plugin  # noqa: F401


def run_lth_continuation_composite_plugin(config, structure, setup_params=None, data=None):
