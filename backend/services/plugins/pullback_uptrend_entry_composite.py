"""Composite wrapper for pullback_uptrend_entry_composite — uses composite_runner.py"""

from plugins.composite_runner import run_composite_plugin  # noqa: F401


def run_pullback_uptrend_entry_composite_plugin(config, structure, setup_params=None, data=None):
