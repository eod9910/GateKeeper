"""Composite wrapper for rdp_fib_pullback_entry_composite — uses composite_runner.py"""

from plugins.composite_runner import run_composite_plugin  # noqa: F401


def run_rdp_fib_pullback_entry_composite_plugin(config, structure, setup_params=None, data=None):
