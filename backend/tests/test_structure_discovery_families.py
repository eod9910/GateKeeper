...
class StructureDiscoveryFamilyTests(unittest.TestCase):
    def test_family_aggregation_groups_by_signature_and_computes_stats(self):
        ...
        self.assertAlmostEqual(family_a.forward_10_std_dev_atr, 0.3535533905932738)
        self.assertAlmostEqual(family_a.forward_10_std_error_atr, 0.25)
        self.assertAlmostEqual(family_a.t_score_forward_10, 3.0)
        self.assertAlmostEqual(family_a.sharpe_like_forward_10, 2.1213203435596424)
