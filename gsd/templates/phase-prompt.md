...
<!-- For checkpoint task examples and patterns, see @~/.cursor/get-shit-done/references/checkpoints.md -->
...
See `~/.cursor/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `~/.cursor/get-shit-done/workflows/verify-phase.md` for verification logic.
