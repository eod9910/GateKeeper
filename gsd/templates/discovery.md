...
3. **web_search** - For comparisons, trends, community patterns (verify all findings)
...
- [ ] API syntax/configuration from Context7 or official docs (never web_search alone)
- [ ] web_search findings cross-checked with authoritative sources
...
- MEDIUM: web_search + Context7/official docs confirm
- LOW: web_search only or training knowledge only (mark for validation)
