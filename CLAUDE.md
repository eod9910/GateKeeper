...
This project is indexed by GitNexus as **pattern-detector** (45103 symbols, 54782 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
