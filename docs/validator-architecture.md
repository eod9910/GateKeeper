...
For validation philosophy and tier rules, see `docs/strategy-validation-policy.md`.

For the Primitive -> Composite -> Strategy boundary, see `docs/indicator/indicator-architecture.md`.
