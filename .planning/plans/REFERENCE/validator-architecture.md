...
For validation philosophy and tier rules, see `.planning/plans/REFERENCE/strategy-validation-policy.md`.

For the Primitive -> Composite -> Strategy boundary, see `.planning/plans/REFERENCE/indicator/indicator-architecture.md`.
