...
- `.planning/plans/REFERENCE/codebase/ARCHITECTURE.md`
- `.planning/plans/REFERENCE/codebase/STRUCTURE.md`
- `.planning/plans/REFERENCE/codebase/STACK.md`
- `.planning/plans/REFERENCE/codebase/INTEGRATIONS.md`
- `.planning/plans/REFERENCE/codebase/TESTING.md`
- `.planning/plans/REFERENCE/codebase/CONVENTIONS.md`
- `.planning/plans/REFERENCE/codebase/CONCERNS.md`
...
`.planning/plans/` is for planning artifacts:
