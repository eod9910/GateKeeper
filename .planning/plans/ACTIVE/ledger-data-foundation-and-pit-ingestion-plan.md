...
- v0 canonical fact schema now exists in `docs/ledger-canonical-fact-schema.md`
...
- largely completed for v0 through `docs/ledger-canonical-fact-schema.md` and the implemented `pit_statement_facts` / `pit_documents` tables
