...
This project is indexed by GitNexus as **pattern-detector** (64975 symbols, 74641 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
