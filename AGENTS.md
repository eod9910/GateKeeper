...
This project is indexed by GitNexus as **pattern-detector** (11531 symbols, 32514 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
